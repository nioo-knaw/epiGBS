...
ln -s ./epiGBS/de_novo_reference_creation/rename_fast.py ~/.conda/envs/epiGBS/bin
# execute the reference pipeline after replacing by the correct directory name
python2 ./epiGBS/de_novo_reference_creation/make_reference.py \
...
--threads 20 \
--barcodes ./subset_for_fleur/H53KHCCXY_L5.tsv \
