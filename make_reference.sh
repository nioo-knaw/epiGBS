...
--forward ./demultiplex_test_data/seqo6ZJkJ/R1_demultiplex_test_data_H53KHCCXY_s_5_fastq.txt.gz \
--reverse ./demultiplex_test_data/seqo6ZJkJ/R2_demultiplex_test_data_H53KHCCXY_s_5_fastq.txt.gz \
--threads 4 \
